...
insert into goods (gCode, gCategory, gName, gContent, gPrice, gImage) values ("SC-0001", "Sauce", "굴소스", "노브랜드 굴소스 490g", 3580, "SC-0001");
insert into goods (gCode, gCategory, gName, gContent, gPrice, gImage) values ("SC-0002", "Sauce", "다진마늘", "냉동 다진마늘 400g", 7900, "SC-0002");
...
insert into goods (gCode, gCategory, gName, gContent, gPrice, gImage) values ("FS-0001", "Fish", "고등어", "노브랜드 [냉동][노르웨이] 손질 고등어 (800g)", 10980, "FS-0001");
insert into goods (gCode, gCategory, gName, gContent, gPrice, gImage) values ("FS-0002", "Fish", "낙지", "[냉동][태국] 먹기좋게 손질된 낙지 (500g)", 9980, "FS-0002");
